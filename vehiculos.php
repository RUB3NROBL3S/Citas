...
<head>
  ...
  <title>Vehículos Citas Virtual</title>
...
<body>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="#" class="active">Registro de Vehículos</a></li>
    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between">
        ...
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Bienvenido al módulo de Registro de Vehículos.</h21>
          </div>

          <div class="col-lg-5 order-1 order-lg-2 hero-img " data-aos="zoom-out">
            <img src="assets/img/truck_icon.svg" class="img-fluid mb-3 mb-lg-0"  alt="">
          </div>
 ...
 <!-- ======= Formulario de vehiculos ======= --> 
   <div class="container mt-5">
       <!-- AGREGAR NUEVOS VEHICULOS -->
           ...
           <div class="card shadow mb-4">
                      <div class="card-header py-3">
                          <h5 class="m-0 font-weight-bold text-dark">INGRESE LOS DATOS REQUERIDOS PARA EL REGISTRO DE VEHICULOS.</h5>
                      </div>
           ...
           <div class="card-body" >
               ...
               <form class="row g-3" action="vehiculo_agregar.php" method="POST">
                   ...
                   <div class="col-md-6">
                       ...
                       <select type="text" name="categoria" class="form-control" required>
                        ...
                        <option value="C2 Camión Rígido">C2 Camión Rígido</option>
                        <option value="C3 Camion Rígido doble tracción">C3 Camion Rígido doble tracción </option>
                        <option value="C2S1 Tractomula de 1 eje">C2S1 Tractomula de 1 eje</option>
                        <option value="C2S2 Tractomula de 2 ejes">C2S2 Tractomula de 2 ejes</option>
                        </Select>
                   </div>

                   <div class="col-md-6">
                       <label for="nombre" class="form-label">Nombre del Conductor</label>
                       <input type="text" name="nombre" class="form-control" required>
                   </div>

                   <div class="col-md-6">
                       <label for="documento" class="form-label">Identificación del Conductor</label>
                       <input type="text" name="documento" class="form-control" required>
                   </div>
                   <p></p>

                   <div class="d-flex gap-1 justify-content-center mt-1">
                       <button type="submit" class="btn btn-primary" value="daftar" name="vehiculo_agregar"><i class="fa fa-plus"></i><span class="ms-2">Agregar Vehículo</span></button>
                   </div>
               </form>   
           </div>
       </div>
       ...
       <div class="card shadow mb-4">
           <div class="card-header py-3">
                   <h5 class="m-0 font-weight-bold text-dark">TABLA DE DATOS DE VEHICULOS AUTORIZADOS.</h5>
           </div>
         
           <!-- Barra de busqueda -->
           <div class="card-header py-3">
               <form class="input-group"  method="get" action="">
                   <input type="text" class="form-control bg-light border-3 small" placeholder="Buscar Vehiculo por número de placa..." aria-label="Search" aria-describedby="basic-addon2" name="buscar" title="buscar">
           ...
           <!-- Funcion de busqueda -->
            ...
            if (isset($_GET['buscar'])) 
            {
                ...
                $sql = "SELECT * FROM vehiculos WHERE placa LIKE '%$busqueda%'";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<th scope='col'>Placa del Vehículo</th>";
                    echo "<th scope='col'>Categoría</th>";
                    echo "<th scope='col'>Nombre del Conductor</th>";
                    echo "<th scope='col'>Identificación del Conductor</th>";
           ...
           <div class="table-responsive mb-5 card">
               ...
               $data = mysqli_query($db, "SELECT * FROM vehiculos");
               $jumlah_data = mysqli_num_rows($data);
               $total_pagina = ceil($jumlah_data / $batas);

               $data_mhs = mysqli_query($db, "SELECT * FROM vehiculos LIMIT $pagina_awal, $batas");
               $no = $pagina_awal + 1;
               ...
               while ($vehiculos = mysqli_fetch_array($data_mhs)) {
                   echo "<tr>";
                   echo "<td style='display:none'>" . $vehiculos['id'] . "</td>";
                   echo "<td class='text-center'>" . $no++ . "</td>";
                   echo "<td>" . $vehiculos['placa'] . "</td>";
                   echo "<td>" . $vehiculos['categoria'] . "</td>"; 
                   echo "<td>" . $vehiculos['nombre'] . "</td>";
                   echo "<td>" . $vehiculos['documento'] . "</td>";
                   echo "<td class='text-center'>";
               ...
               if ($jumlah_data == 0) {
                   ...
                   echo "<p>Total Vehiculos Registrados: $jumlah_data </p>";
               }
       ...
       <div class='modal fade' style="top:58px !important;" id='editModal' tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true'>
           <div class='modal-dialog' style="margin-bottom:100px !important;">
               <div class='modal-content'>
                   ...
                   $query = mysqli_query($db, $sql);
                   $vehiculos = mysqli_fetch_array($query);
                   ?>
                       ...
                       <div class='modal-body text-start'>
                           ...
                           <div class="col-12 mb-3">
                               <label for="edit_categoria" class="form-label">Categoría</label>
                                <select type="text" name="edit_categoria" class="form-control" id="edit_categoria" required>
                                    <option value="Seleccione"> </option>
                                    <option value="C2 Camión Rígido">C2 Camión Rígido</option>
                                    <option value="C3 Camion Rígido doble tracción">C3 Camion Rígido doble tracción </option>
                                    <option value="C2S1 Tractomula de 1 eje">C2S1 Tractomula de 1 eje</option>
                           ...
                           <div class="col-12 mb-3">
                               <label for="documento" class="form-label">Identificacion del Conductor</label>
                               <input type="text" name="edit_documento" id="edit_documento" class="form-control" required>
                           </div>
                       </div>
       ...
       <div class='modal fade' style="top:58px !important;" id='deleteModal' tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true'>
           <div class='modal-dialog'>
               <div class='modal-content'>
                   ...
                   <form action='vehiculo_borrar.php' method='POST'>
   ...
   <script>
       $(document).ready(function() {
           $('.editButton').on('click', function() {
               ...
               console.log(data);
               $('#edit_id').val(data[0]);
               $('#edit_placa').val(data[2]);
               $('#edit_categoria').val(data[3]);
               $('#edit_nombre').val(data[4]);
               $('#edit_documento').val(data[5]);
           });
       });
   </script>
